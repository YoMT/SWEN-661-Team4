    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/medications', builder: (ctx, state) => const MedicationListScreen()),
          GoRoute(path: '/medications/new', builder: (ctx, state) => const MedicationFormScreen()),
          GoRoute(
            path: '/appointments',
            builder: (ctx, state) => const AppointmentScreen(),
            routes: [
              GoRoute(path: 'new', builder: (ctx, state) => const NewAppointmentScreen()),
              GoRoute(path: 'video', builder: (ctx, state) => const VideoVisitScreen()),
              GoRoute(path: 'reschedule', builder: (ctx, state) => const RescheduleScreen()),
            ],
          ),
          GoRoute(path: '/symptoms', builder: (ctx, state) => const SymptomLogScreen()),
          GoRoute(path: '/accessibility', builder: (ctx, state) => const AccessibilityScreen()),
          GoRoute(path: '/emergency', builder: (ctx, state) => const EmergencyContactScreen()),
          GoRoute(path: '/report', builder: (ctx, state) => const CaretakerNotesScreen()),
