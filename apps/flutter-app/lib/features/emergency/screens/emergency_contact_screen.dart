...
class _EmergencyContactScreenState extends State<EmergencyContactScreen> {
  ...
  void _startCall911() async {
    ...
    // 3-second countdown — user can cancel
    for (int i = 3; i > 0; i--) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // SOS Card (Pillar 2: hold to prevent accidental call)
          Container(
          ...
          // Quick incident log (from Figma design)
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              color: AppColors.surface,
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  onChanged: (v) => context.read<EmergencyProvider>().setIncidentNote(v),
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: provider.incidentSaved
                        ? null
                        : () async {
                            await context.read<EmergencyProvider>().saveIncident();
